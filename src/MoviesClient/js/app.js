...
.config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when('/movies/add', { templateUrl: 'partials/movie.html', controller: 'movieController' });
    $routeProvider.when('/movies/update/:cacheId', { templateUrl: 'partials/movie.html', controller: 'movieController' });
